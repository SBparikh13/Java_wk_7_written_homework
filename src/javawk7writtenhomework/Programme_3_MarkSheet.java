...
public class Programme_3_MarkSheet {
    ...
    public static int sum(int a, int b, int c) {//calculating the sun
        return a + b + c;
    }
    public static String calculateResult(int mathsMarks, int scienceMarks, int englishMarks) { // Calculating the results on subjects marks
    ...
    public static String calculateGrade(int percentage, String result) {// Calculating the grade on percentage and result
        String grade = null;
